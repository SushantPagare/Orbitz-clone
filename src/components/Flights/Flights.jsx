    ...
    <div>
      <div>
        <div className="search-main">
          <h1>Find and compare flights</h1>
          ...
          <div className="whatsnewdiv">
            <div className="whatsnewdiv-1">
              <div className="whatsnew-img">
                <img src="https://forever.travel-assets.com/flex/flexmanager/images/2021/01/25/ORB_FlexibleFligthDeals_lpheroB_1680x945_20201106.jpg?impolicy=fcrop&w=900&h=506&q=mediumHigh" />
              </div>
              <h2>Flexible Flight Deals</h2>
              <p>
                Find fares under $ 199 wiht zero change fees. Book with
                confidence.
              </p>
            </div>
            <div className="whatsnewdiv-2">
              ...
              <div>
                <img
                  src="https://forever.travel-assets.com/flex/flexmanager/images/2021/02/08/ORB_UnitedAirlinesFlights_lpheroB_1680x945_20210202.jpg?impolicy=fcrop&w=300&h=300&q=mediumHigh"
                  alt=""
                />
                <div>
                  <h3>United Airlines Flights</h3>
                  <p>
                    United Airlines has great fares to get you where you want to
                    go.
                  </p>
                </div>
              </div>
        ...
        <div className="travel">
          <div>
            <div className="travel1-1">
              <h3>Airport codes and what they really mean</h3>
            </div>
            <p>
              We explain the fascinating truth behind the world’s weirdest, most
              wonderful airport codes.
            </p>
          </div>
          <div>
            <div className="travel2-1">
              <h3>7 reasons why aircraft type actually matters</h3>
            </div>
            <p>
              7 reasons why aircraft type actually matters The type of plane can
              make a world of difference in your flying experience. Find out
              more.
            </p>
          </div>
          <div>
